...
-- Insert HR User (Night Shift Example: 20:00 - 04:00)
...
-- Insert Agent User (ali) - Night Shift Example
INSERT INTO users (username, password, full_name, extension_number, role, base_salary, shift_start, shift_end, employment_type)
VALUES (
    'ali',
    '$2a$10$CSO62OuE7HbVcvLkr6107.yv6/1L/1xWLpM5lCsOPFxNs/EjWbwWO',
...
-- ============================================================================
-- HELPFUL VIEWS & QUERIES
-- ============================================================================

-- View: Get user with calculated daily potential (base_salary / 22)
-- SELECT id, username, full_name, extension_number, role, base_salary, 
--        ROUND(base_salary / 22.0, 2) as daily_potential,
--        shift_start, shift_end, employment_type
-- FROM users WHERE is_active = true;

-- View: Check if user is within their shift (handles overnight shifts)
-- SELECT id, full_name, shift_start, shift_end,
--        CASE 
--          WHEN shift_start < shift_end THEN 
--            CURRENT_TIME BETWEEN shift_start AND shift_end
--          ELSE 
